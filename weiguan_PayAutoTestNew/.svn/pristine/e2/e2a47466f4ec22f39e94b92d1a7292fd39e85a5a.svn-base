...
import com.mls.pay.access.databean.OrderInfo;
...
public class NormalOrder_bak extends BaseTest {

    @BeforeClass
    public void create_tbody() {
        try {
            CreateResult.create_tbody("normalorder");
    ...
    public void normalorder(String id, String sharaData, String busiTypeId,
        ...
        ********开始测试
        ...
        try {
            ...
            CreateResult.appendResult("normalorder", bankCode,ordertype,payway,orderNo,flag, errmsg);
        }
