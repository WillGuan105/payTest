...
public class PayAccessInter {
    ...
    public void payaccess(String name,String link,String expect,String para,String linkpara) throws SQLException {
        ...
        try {
            ...
            if(para.contains("0yuangou")){
                String orderNo="15"+ CommonMethod.get_random_string(12);
                result=create_0yuangou(orderNo);
            }else {
    ...
    //创建0元购订单
    public String create_0yuangou(String orderno){
        String result="";
        ...
        String order_para = "bgRetUrl="+bgRetUrl+"&browserType=NIE&busiTypeId=DOOTA&curId=CNY"+
                ...
                "&source=1-5.2&transTypeId=DANBAO&userAccount="+ CommonTest.userAccount+"&validityDate="+CommonTest.validityDate+ "&version=20131111";
        try {
            result=CommonTest.orderinfoTest(orderno,order_para);
    ...
    public String create_payinfo(String orderno) {
        String payid="";
        String pay_para = "access_token=" + CommonTest.access_token + "&r=generatepayinfo&merchantcode=MLS_I_00000002&orderno=" + orderno + "&pmcode=WAPQCCARD&bankcode=CEB&paytype=4&source=1-5.2&version=20131111&usedamount=0&payamount=0.01";
